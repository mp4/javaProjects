/*
 * most of the code is written by the author so blame him all i added was the 
 * wrapper class to the code to seperate it from the application code
 * edited by marsh poulson 10/26/2013
 */
package poulproj08;

/*
 * this class contains all of the different implementations of sorting 
 * algorithms 
 */
public class sorts {
    ...
    private static <T extends Comparable<? super T>> int indexOfLargest(
            T[] theArray, int size) {
        // ---------------------------------------------------
...
// unchecked cast from Comparable<?>[] to T[]
    ...
    private static <T extends Comparable<? super T>> void choosePivot(
            T[] theArray, int first, int last) {
        // ---------------------------------------------------------
